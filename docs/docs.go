...
// 2021-11-11 20:04:20.393576 +0100 WAT m=+27.776446543
package docs
...
var doc = `{
    ...
    "paths": {
        ...
        "/events/{eventID}/eventdeliveries": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/events/{eventID}/eventdeliveries/{eventDeliveryID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/events/{eventID}/eventdeliveries/{eventDeliveryID}/resend": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
