// Package docs Code generated by swaggo/swag at 2024-03-22 19:48:45.014437 +0000 GMT m=+2.621618084. DO NOT EDIT
package docs
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Go ` + "`" + `forward` + "`" + ` or ` + "`" + `backward` + "`" + ` in the records.",
                        "name": "direction",
                        "in": "query"
                    },
                    {
