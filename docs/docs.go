...
// 2021-10-22 13:20:15.187158 +0100 WAT m=+26.083970001
package docs
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "content": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/convoy.Message"
                                                            }
                                                        }
                                                    }
                                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/convoy.MessageAttempt"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "convoy.MessageMetadata": {
            ...
            "properties": {
                ...
                "next_send_time": {
                    "description": "NextSendTime denotes the next time a message will be published in\ncase it failed the first time",
                    "type": "integer"
                },
                "num_trials": {
                    "description": "NumTrials: number of times we have tried to deliver this message to\nan application",
                    "type": "integer"
                },
                "retry_limit": {
                    "type": "integer"
