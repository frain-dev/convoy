...
// 2021-11-08 18:48:57.875051 +0100 WAT m=+29.499272251
package docs
...
var doc = `{
    ...
    "paths": {
        ...
        "/events/{eventID}/eventdelivery/resend": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/events/{eventID}/eventdelivery/{eventDeliveryID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/events/{eventID}/eventdelivery/{eventDeliveryID}/deliveryattempts": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/events/{eventID}/eventdelivery/{eventDeliveryID}/deliveryattempts/{deliveryAttemptID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
