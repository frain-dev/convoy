...
// 2022-10-18 23:23:07.425181 +0100 WAT m=+1.467003251
package docs
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/projects/{projectID}/applications/{appID}/endpoints/{endpointID}/secrets": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/projects/{projectID}/applications/{appID}/endpoints/{endpointID}/secrets/{secretID}/expire": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
