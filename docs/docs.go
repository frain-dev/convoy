...
// 2022-10-16 11:15:00.782901 +0100 WAT m=+1.564148459
package docs
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/applications/{appID}/endpoints/{endpointID}/secrets": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/applications/{appID}/endpoints/{endpointID}/secrets/{secretID}/expire": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
