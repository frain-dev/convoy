...
// 2022-09-12 17:11:24.903614 +0100 WAT m=+0.816133292
package docs
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/applications/{appID}/endpoints": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/applications/{appID}/endpoints/{endpointID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github.com_frain-dev_convoy_server.Stub"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/security/applications/{appID}/keys": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "allOf": [
                                                {
                                                    "$ref": "#/definitions/github.com_frain-dev_convoy_server.pagedResponse"
                                                },
                                                {
                                                    "type": "object",
                                                    "properties": {
    ...
    "definitions": {
        ...
        "github.com_frain-dev_convoy_server.Stub": {
            "type": "object"
        },
        "github.com_frain-dev_convoy_server.pagedResponse": {
            "type": "object",
            "properties": {
                "content": {},
                "pagination": {
