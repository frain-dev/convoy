...
// 2022-07-29 10:10:07.426728732 +0100 WAT m=+100.238764238
package docs
    ...
    "definitions": {
        ...
        "models.Subscription": {
            ...
            "properties": {
                ...
                "app_id": {
                    "description": "Type       string ` + "`" + `json:\"type\" bson:\"type\" valid:\"required~please provide a valid subscription type\"` + "`" + `",
                    "type": "string"
                },
                "endpoint_id": {
                    "type": "string"
