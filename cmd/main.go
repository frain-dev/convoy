...
func main() {
	...
	// Billing flags
	c.Flags().StringVar(&billingURL, "billing-url", "", "Billing service URL")
	c.Flags().StringVar(&billingAPIKey, "billing-api-key", "", "Billing service API key for cloud org billing")
