...
func (q *Queries) CountInstanceAdminUsers(ctx context.Context) (pgtype.Int8, error) {
...
func (q *Queries) CountOrganisationAdminUsers(ctx context.Context) (pgtype.Int8, error) {
...
func (q *Queries) CountPrevOrganisationMembers(ctx context.Context, arg CountPrevOrganisationMembersParams) (pgtype.Int8, error) {
...
type FetchAnyOrganisationAdminByUserIDRow struct {
	...
	UserMetadataUserID    string
	UserMetadataFirstName string
	UserMetadataLastName  string
