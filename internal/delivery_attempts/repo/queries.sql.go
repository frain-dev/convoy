...
func (q *Queries) FindDeliveryAttempts(ctx context.Context, eventDeliveryID pgtype.Text) ([]FindDeliveryAttemptsRow, error) {
...
type GetFailureAndSuccessCountsRow struct {
	Key       string
	TenantID  string
	Failures  pgtype.Int8
	Successes pgtype.Int8
}
...
func (q *Queries) GetFailureAndSuccessCounts(ctx context.Context, lookBackDuration pgtype.Int4) ([]GetFailureAndSuccessCountsRow, error) {
