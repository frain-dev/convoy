...
func configurationToCreateParams(cfg *datastore.Configuration) repo.CreateConfigurationParams {
	params := repo.CreateConfigurationParams{
		ID:                 pgtype.Text{String: cfg.UID, Valid: true},
		IsAnalyticsEnabled: pgtype.Text{String: boolToText(cfg.IsAnalyticsEnabled), Valid: true},
	...
	if cfg.StoragePolicy != nil {
		params.StoragePolicyType = pgtype.Text{String: string(cfg.StoragePolicy.Type), Valid: true}
	...
	params.RetentionPolicyPolicy = pgtype.Text{String: rc.Policy, Valid: true}
