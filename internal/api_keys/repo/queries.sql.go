...
func (q *Queries) FindAPIKeyByHash(ctx context.Context, hash pgtype.Text) (FindAPIKeyByHashRow, error) {
...
// ============================================================================
func (q *Queries) FindAPIKeyByID(ctx context.Context, id pgtype.Text) (FindAPIKeyByIDRow, error) {
...
func (q *Queries) FindAPIKeyByMaskID(ctx context.Context, maskID pgtype.Text) (FindAPIKeyByMaskIDRow, error) {
