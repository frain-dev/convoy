...
type Querier interface {
	...
	FindAPIKeyByHash(ctx context.Context, hash pgtype.Text) (FindAPIKeyByHashRow, error)
	// ============================================================================
	// READ Operations - Single Record
	// ============================================================================
	FindAPIKeyByID(ctx context.Context, id pgtype.Text) (FindAPIKeyByIDRow, error)
	// CRITICAL: Used for API key authentication in NativeRealm
	FindAPIKeyByMaskID(ctx context.Context, maskID pgtype.Text) (FindAPIKeyByMaskIDRow, error)
