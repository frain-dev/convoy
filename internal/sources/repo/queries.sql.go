...
type CountPrevSourcesParams struct {
	...
	Cursor            pgtype.Text
	HasTypeFilter     pgtype.Bool
	TypeFilter        pgtype.Text
	HasProviderFilter pgtype.Bool
	ProviderFilter    pgtype.Text
	HasQueryFilter    pgtype.Bool
	QueryFilter       pgtype.Text
}

// Unified count query for pagination prev row count
func (q *Queries) CountPrevSources(ctx context.Context, arg CountPrevSourcesParams) (pgtype.Int8, error) {
...
func (q *Queries) DeleteSourceVerifier(ctx context.Context, id pgtype.Text) error {
...
type FetchSourceByIDRow struct {
	...
	CustomResponseBody        pgtype.Text
	CustomResponseContentType pgtype.Text
	VerifierType              pgtype.Text
	VerifierBasicUsername     pgtype.Text
	VerifierBasicPassword     pgtype.Text
	VerifierApiKeyHeaderName  pgtype.Text
	VerifierApiKeyHeaderValue pgtype.Text
	VerifierHmacHash          pgtype.Text
	VerifierHmacHeader        pgtype.Text
	VerifierHmacSecret        pgtype.Text
	VerifierHmacEncoding      pgtype.Text
	CreatedAt                 pgtype.Timestamptz
	UpdatedAt                 pgtype.Timestamptz
}
...
// FETCH Operations
// ============================================================================
func (q *Queries) FetchSourceByID(ctx context.Context, id pgtype.Text) (FetchSourceByIDRow, error) {
...
func (q *Queries) FetchSourceByMaskID(ctx context.Context, maskID pgtype.Text) (FetchSourceByMaskIDRow, error) {
