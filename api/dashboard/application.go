...
func (a *DashboardHandler) CreateApp(w http.ResponseWriter, r *http.Request) {
	newApp := struct {
...
func (a *DashboardHandler) GetApps(w http.ResponseWriter, r *http.Request) {
	project := m.GetProjectFromContext(r.Context())
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
...
func (a *DashboardHandler) GetApp(w http.ResponseWriter, r *http.Request) {
...
func (a *DashboardHandler) UpdateApp(w http.ResponseWriter, r *http.Request) {
	endpoints := m.GetEndpointsFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
...
func (a *DashboardHandler) DeleteApp(w http.ResponseWriter, r *http.Request) {
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
	project := m.GetProjectFromContext(r.Context())
...
func (a *DashboardHandler) CreateAppEndpoint(w http.ResponseWriter, r *http.Request) {
	project := m.GetProjectFromContext(r.Context())
...
func (a *DashboardHandler) GetAppEndpoints(w http.ResponseWriter, r *http.Request) {
	endpoints := m.GetEndpointsFromContext(r.Context())
...
func (a *DashboardHandler) GetAppEndpoint(w http.ResponseWriter, r *http.Request) {
...
func (a *DashboardHandler) UpdateAppEndpoint(w http.ResponseWriter, r *http.Request) {
	endpoint := m.GetEndpointFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
...
func (a *DashboardHandler) DeleteAppEndpoint(w http.ResponseWriter, r *http.Request) {
	endpoint := m.GetEndpointFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
	es := createEndpointService(a)
