...
func (s *PortalLinkIntegrationTestSuite) Test_CreatePortalLink() {
	...
	// Arrange Request
	url := fmt.Sprintf("/v1/projects/%s/portal-links", s.DefaultProject.UID)
...
func (s *PortalLinkIntegrationTestSuite) Test_GetPortalLinkByID_PortalLinkNotFound() {
	...
	// Arrange Request
	url := fmt.Sprintf("/v1/projects/%s/portal-links/%s", s.DefaultProject.UID, portalLinkID)
...
func (s *PortalLinkIntegrationTestSuite) Test_GetPortalLinkByID_ValidPortalLink() {
	...
	// Arrange Request
	url := fmt.Sprintf("/v1/projects/%s/portal-links/%s", s.DefaultProject.UID, portalLink.UID)
	req := createRequest(http.MethodGet, url, s.APIKey, nil)
	w := httptest.NewRecorder()
...
func (s *PortalLinkIntegrationTestSuite) Test_GetPortalLinks_ValidPortalLinks_FilterByEndpointID() {
	...
	// Arrange Request
	url := fmt.Sprintf("/v1/projects/%s/portal-links?endpointId=%s", s.DefaultProject.UID, endpoint.UID)
	req := createRequest(http.MethodGet, url, s.APIKey, nil)
	w := httptest.NewRecorder()
...
func (s *PortalLinkIntegrationTestSuite) Test_RevokePortalLink() {
	...
	// Arrange Request.
	url := fmt.Sprintf("/v1/projects/%s/portal-links/%s/revoke", s.DefaultProject.UID, portalLink.UID)
