...
func (a *PublicHandler) CreateApp(w http.ResponseWriter, r *http.Request) {
	newApp := struct {
...
func (a *PublicHandler) GetApps(w http.ResponseWriter, r *http.Request) {
	project := m.GetProjectFromContext(r.Context())
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
...
func (a *PublicHandler) GetApp(w http.ResponseWriter, r *http.Request) {
...
func (a *PublicHandler) UpdateApp(w http.ResponseWriter, r *http.Request) {
	endpoints := m.GetEndpointsFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
...
func (a *PublicHandler) DeleteApp(w http.ResponseWriter, r *http.Request) {
	endpointRepo := postgres.NewEndpointRepo(a.A.DB)
	project := m.GetProjectFromContext(r.Context())
...
func (a *PublicHandler) CreateAppEndpoint(w http.ResponseWriter, r *http.Request) {
	project := m.GetProjectFromContext(r.Context())
...
func (a *PublicHandler) GetAppEndpoints(w http.ResponseWriter, r *http.Request) {
	endpoints := m.GetEndpointsFromContext(r.Context())
...
func (a *PublicHandler) GetAppEndpoint(w http.ResponseWriter, r *http.Request) {
...
func (a *PublicHandler) UpdateAppEndpoint(w http.ResponseWriter, r *http.Request) {
	endpoint := m.GetEndpointFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
...
func (a *PublicHandler) DeleteAppEndpoint(w http.ResponseWriter, r *http.Request) {
	endpoint := m.GetEndpointFromContext(r.Context())
	project := m.GetProjectFromContext(r.Context())
	es := createEndpointService(a)
