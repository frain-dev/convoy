...
func (mr *MockLicenserMockRecorder) AddEnabledProject(projectID interface{}) *gomock.Call {
...
func (mr *MockLicenserMockRecorder) CreateOrg(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLicenserMockRecorder) CreateProject(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLicenserMockRecorder) CreateUser(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLicenserMockRecorder) FeatureListJSON(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLicenserMockRecorder) ProjectEnabled(projectID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLicenserMockRecorder) RemoveEnabledProject(projectID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
