...
//
//	mockgen --source internal/pkg/memorystore/table.go --destination mocks/table.go -package mocks
//
...
func (mr *MockITableMockRecorder) Get(key any) *gomock.Call {
...
func (mr *MockITableMockRecorder) GetItems(prefix any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSyncerMockRecorder) SyncChanges(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
