...
func (mr *MockRateLimiterMockRecorder) Allow(ctx, key, rate interface{}) *gomock.Call {
...
func (mr *MockRateLimiterMockRecorder) AllowWithDuration(ctx, key, rate, duration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
