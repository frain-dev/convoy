...
func (m *MockBackend) Capture(ctx context.Context, name string, attributes map[string]interface{}, startTime, endTime time.Time) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Capture", ctx, name, attributes, startTime, endTime)
}

// Capture indicates an expected call of Capture.
func (mr *MockBackendMockRecorder) Capture(ctx, name, attributes, startTime, endTime interface{}) *gomock.Call {
...
func (mr *MockBackendMockRecorder) Init(componentName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendMockRecorder) Shutdown(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
