...
//
//	mockgen --source datastore/repository.go --destination mocks/repository.go -package mocks
//
...
func (mr *MockEventDeliveryRepositoryMockRecorder) CountDeliveriesByStatus(ctx, projectID, status, params any) *gomock.Call {
...
func (mr *MockEventDeliveryRepositoryMockRecorder) CountEventDeliveries(ctx, projectID, endpointIDs, eventID, status, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) CreateEventDeliveries(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) ExportRecords(ctx, start, end, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExportRecords", reflect.TypeOf((*MockEventDeliveryRepository)(nil).ExportRecords), ctx, start, end, w)
}
...
func (mr *MockEventDeliveryRepositoryMockRecorder) FindDiscardedEventDeliveries(ctx, projectID, deviceId, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) FindEventDeliveriesByEventID(ctx, projectID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) FindEventDeliveriesByIDs(ctx, projectID, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) FindEventDeliveryByID(ctx, projectID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) FindStuckEventDeliveriesByStatus(ctx, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockEventDeliveryRepository) LoadEventDeliveriesPaged(ctx context.Context, projectID string, endpointIDs []string, eventID, subscriptionID string, status []datastore.EventDeliveryStatus, params datastore.SearchParams, pageable datastore.Pageable, idempotencyKey, eventType, brokerMessageId string) ([]datastore.EventDelivery, datastore.PaginationData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadEventDeliveriesPaged", ctx, projectID, endpointIDs, eventID, subscriptionID, status, params, pageable, idempotencyKey, eventType, brokerMessageId)
	ret0, _ := ret[0].([]datastore.EventDelivery)
...
func (mr *MockEventDeliveryRepositoryMockRecorder) LoadEventDeliveriesPaged(ctx, projectID, endpointIDs, eventID, subscriptionID, status, params, pageable, idempotencyKey, eventType, brokerMessageId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadEventDeliveriesPaged", reflect.TypeOf((*MockEventDeliveryRepository)(nil).LoadEventDeliveriesPaged), ctx, projectID, endpointIDs, eventID, subscriptionID, status, params, pageable, idempotencyKey, eventType, brokerMessageId)
}
...
func (mr *MockEventDeliveryRepositoryMockRecorder) UpdateStatusOfEventDeliveries(ctx, projectID, ids, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventDeliveryRepositoryMockRecorder) UpdateStatusOfEventDelivery(ctx, projectID, eventDelivery, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) CopyRows(ctx, projectID, interval any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) CountEvents(ctx, projectID, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) CountProjectMessages(ctx, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ExportRecords indicates an expected call of ExportRecords.
func (mr *MockEventRepositoryMockRecorder) ExportRecords(ctx, start, end, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExportRecords", reflect.TypeOf((*MockEventRepository)(nil).ExportRecords), ctx, start, end, w)
}
...
func (mr *MockEventRepositoryMockRecorder) FindEventByID(ctx, projectID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) FindEventsByIDs(ctx, projectID, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) FindEventsByIdempotencyKey(ctx, projectID, idempotencyKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) FindFirstEventWithIdempotencyKey(ctx, projectID, idempotencyKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryMockRecorder) DeleteProject(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryMockRecorder) FetchProjectByID(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryMockRecorder) FillProjectsStatistics(ctx, project any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryMockRecorder) GetProjectsWithEventsInTheInterval(ctx, interval any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryMockRecorder) LoadProjects(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockOrganisationRepository) CreateOrganisation(ctx context.Context, org *datastore.Organisation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrganisation", ctx, org)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateOrganisation indicates an expected call of CreateOrganisation.
func (mr *MockOrganisationRepositoryMockRecorder) CreateOrganisation(ctx, org any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrganisation", reflect.TypeOf((*MockOrganisationRepository)(nil).CreateOrganisation), ctx, org)
}

// DeleteOrganisation mocks base method.
func (m *MockOrganisationRepository) DeleteOrganisation(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
...
func (mr *MockOrganisationRepositoryMockRecorder) DeleteOrganisation(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteOrganisation", reflect.TypeOf((*MockOrganisationRepository)(nil).DeleteOrganisation), ctx, id)
}

// FetchOrganisationByAssignedDomain mocks base method.
func (m *MockOrganisationRepository) FetchOrganisationByAssignedDomain(ctx context.Context, domain string) (*datastore.Organisation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchOrganisationByAssignedDomain", ctx, domain)
...
func (mr *MockOrganisationRepositoryMockRecorder) FetchOrganisationByAssignedDomain(ctx, domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchOrganisationByAssignedDomain", reflect.TypeOf((*MockOrganisationRepository)(nil).FetchOrganisationByAssignedDomain), ctx, domain)
}

// FetchOrganisationByCustomDomain mocks base method.
func (m *MockOrganisationRepository) FetchOrganisationByCustomDomain(ctx context.Context, domain string) (*datastore.Organisation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchOrganisationByCustomDomain", ctx, domain)
	ret0, _ := ret[0].(*datastore.Organisation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOrganisationRepositoryMockRecorder) FetchOrganisationByCustomDomain(ctx, domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchOrganisationByCustomDomain", reflect.TypeOf((*MockOrganisationRepository)(nil).FetchOrganisationByCustomDomain), ctx, domain)
}

// FetchOrganisationByID mocks base method.
func (m *MockOrganisationRepository) FetchOrganisationByID(ctx context.Context, id string) (*datastore.Organisation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchOrganisationByID", ctx, id)
	ret0, _ := ret[0].(*datastore.Organisation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOrganisationRepositoryMockRecorder) FetchOrganisationByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchOrganisationByID", reflect.TypeOf((*MockOrganisationRepository)(nil).FetchOrganisationByID), ctx, id)
}

// LoadOrganisationsPaged mocks base method.
func (m *MockOrganisationRepository) LoadOrganisationsPaged(ctx context.Context, pageable datastore.Pageable) ([]datastore.Organisation, datastore.PaginationData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadOrganisationsPaged", ctx, pageable)
	ret0, _ := ret[0].([]datastore.Organisation)
	ret1, _ := ret[1].(datastore.PaginationData)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockOrganisationRepositoryMockRecorder) LoadOrganisationsPaged(ctx, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadOrganisationsPaged", reflect.TypeOf((*MockOrganisationRepository)(nil).LoadOrganisationsPaged), ctx, pageable)
}

// LoadOrganisationsPagedWithSearch mocks base method.
func (m *MockOrganisationRepository) LoadOrganisationsPagedWithSearch(ctx context.Context, pageable datastore.Pageable, search string) ([]datastore.Organisation, datastore.PaginationData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadOrganisationsPagedWithSearch", ctx, pageable, search)
	ret0, _ := ret[0].([]datastore.Organisation)
	ret1, _ := ret[1].(datastore.PaginationData)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockOrganisationRepositoryMockRecorder) LoadOrganisationsPagedWithSearch(ctx, pageable, search any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadOrganisationsPagedWithSearch", reflect.TypeOf((*MockOrganisationRepository)(nil).LoadOrganisationsPagedWithSearch), ctx, pageable, search)
}

// UpdateOrganisation mocks base method.
func (m *MockOrganisationRepository) UpdateOrganisation(ctx context.Context, org *datastore.Organisation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateOrganisation", ctx, org)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateOrganisation indicates an expected call of UpdateOrganisation.
func (mr *MockOrganisationRepositoryMockRecorder) UpdateOrganisation(ctx, org any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAPIKeyRepository) LoadAPIKeysPaged(ctx context.Context, filter *datastore.Filter, pageable *datastore.Pageable) ([]datastore.APIKey, datastore.PaginationData, error) {
	m.ctrl.T.Helper()
...
func (m *MockPortalLinkRepository) CreatePortalLink(ctx context.Context, projectId string, request *datastore.CreatePortalLinkRequest) (*datastore.PortalLink, error) {
	m.ctrl.T.Helper()
...
func (m *MockPortalLinkRepository) UpdatePortalLink(ctx context.Context, projectID string, portalLink *datastore.PortalLink, request *datastore.UpdatePortalLinkRequest) (*datastore.PortalLink, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) CreateOrganisationInvite(ctx, iv any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) DeleteOrganisationInvite(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) FetchOrganisationInviteByID(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) FetchOrganisationInviteByToken(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) LoadOrganisationsInvitesPaged(ctx, orgID, inviteStatus, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationInviteRepositoryMockRecorder) UpdateOrganisationInvite(ctx, iv any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationMemberRepositoryMockRecorder) CreateOrganisationMember(ctx, member any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationMemberRepositoryMockRecorder) FetchOrganisationMemberByID(ctx, memberID, organisationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationMemberRepositoryMockRecorder) FetchOrganisationMemberByUserID(ctx, userID, organisationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockOrganisationMemberRepository) HasInstanceAdminAccess(ctx context.Context, userID string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasInstanceAdminAccess", ctx, userID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOrganisationMemberRepositoryMockRecorder) LoadOrganisationMembersPaged(ctx, organisationID, userID, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrganisationMemberRepositoryMockRecorder) LoadUserOrganisationsPaged(ctx, userID, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) CountProjectEndpoints(ctx, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) CreateEndpoint(ctx, endpoint, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) DeleteEndpoint(ctx, endpoint, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) DeleteSecret(ctx, endpoint, secretID, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) FindEndpointByID(ctx, id, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) FindEndpointByTargetURL(ctx, projectID, targetURL any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) FindEndpointsByAppID(ctx, appID, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) FindEndpointsByID(ctx, ids, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) LoadEndpointsPaged(ctx, projectID, filter, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) UpdateEndpoint(ctx, endpoint, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) UpdateEndpointStatus(ctx, projectID, endpointID, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEndpointRepositoryMockRecorder) UpdateSecrets(ctx, endpointID, projectID, secrets any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) DeleteSubscription(ctx, projectID, subscription any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// FetchNewSubscriptions mocks base method.
func (m *MockSubscriptionRepository) FetchNewSubscriptions(ctx context.Context, projectIDs, knownSubscriptionIDs []string, lastSyncTime time.Time, pageSize int64) ([]datastore.Subscription, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchNewSubscriptions", ctx, projectIDs, knownSubscriptionIDs, lastSyncTime, pageSize)
	ret0, _ := ret[0].([]datastore.Subscription)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FetchNewSubscriptions indicates an expected call of FetchNewSubscriptions.
func (mr *MockSubscriptionRepositoryMockRecorder) FetchNewSubscriptions(ctx, projectIDs, knownSubscriptionIDs, lastSyncTime, pageSize any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchNewSubscriptions", reflect.TypeOf((*MockSubscriptionRepository)(nil).FetchNewSubscriptions), ctx, projectIDs, knownSubscriptionIDs, lastSyncTime, pageSize)
}
...
func (mr *MockSubscriptionRepositoryMockRecorder) FindSubscriptionByID(ctx, projectID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) FindSubscriptionsByEndpointID(ctx, projectId, endpointID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) FindSubscriptionsBySourceID(ctx, projectID, sourceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) LoadSubscriptionsPaged(ctx, projectID, filter, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) UpdateSubscription(ctx, projectID, subscription any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) CreateSource(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) DeleteSourceByID(ctx, projectId, id, sourceVerifierId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) FindSourceByID(ctx, projectId, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) FindSourceByMaskID(ctx, maskId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) FindSourceByName(ctx, projectId, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) LoadPubSubSourcesByProjectIDs(ctx, projectIds, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) LoadSourcesPaged(ctx, projectId, filter, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSourceRepositoryMockRecorder) UpdateSource(ctx, projectId, source any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) DeleteJob(ctx, uid, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) FetchJobById(ctx, uid, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) FetchJobsByProjectId(ctx, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) FetchRunningJobsByProjectId(ctx, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) LoadJobsPaged(ctx, projectID, pageable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) MarkJobAsCompleted(ctx, uid, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) MarkJobAsFailed(ctx, uid, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobRepositoryMockRecorder) MarkJobAsStarted(ctx, uid, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) FindUserByEmailVerificationToken(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConfigurationRepositoryMockRecorder) CreateConfiguration(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConfigurationRepositoryMockRecorder) LoadConfiguration(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConfigurationRepositoryMockRecorder) UpdateConfiguration(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMetaEventRepositoryMockRecorder) CreateMetaEvent(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMetaEventRepositoryMockRecorder) FindMetaEventByID(ctx, projectID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMetaEventRepositoryMockRecorder) LoadMetaEventsPaged(ctx, projectID, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMetaEventRepositoryMockRecorder) UpdateMetaEvent(ctx, projectID, metaEvent any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ExportRecords indicates an expected call of ExportRecords.
func (mr *MockExportRepositoryMockRecorder) ExportRecords(ctx, start, end, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExportRecords", reflect.TypeOf((*MockExportRepository)(nil).ExportRecords), ctx, start, end, w)
}
...
type MockDeliveryAttemptsRepositoryMockRecorder struct {
	mock *MockDeliveryAttemptsRepository
}

// NewMockDeliveryAttemptsRepository creates a new mock instance.
func NewMockDeliveryAttemptsRepository(ctrl *gomock.Controller) *MockDeliveryAttemptsRepository {
	mock := &MockDeliveryAttemptsRepository{ctrl: ctrl}
	mock.recorder = &MockDeliveryAttemptsRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDeliveryAttemptsRepository) EXPECT() *MockDeliveryAttemptsRepositoryMockRecorder {
	return m.recorder
}

// CreateDeliveryAttempt mocks base method.
func (m *MockDeliveryAttemptsRepository) CreateDeliveryAttempt(arg0 context.Context, arg1 *datastore.DeliveryAttempt) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDeliveryAttempt", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateDeliveryAttempt indicates an expected call of CreateDeliveryAttempt.
...
// ExportRecords indicates an expected call of ExportRecords.
func (mr *MockDeliveryAttemptsRepositoryMockRecorder) ExportRecords(ctx, start, end, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExportRecords", reflect.TypeOf((*MockDeliveryAttemptsRepository)(nil).ExportRecords), ctx, start, end, w)
}
