...
func (d *DeviceService) LoadDevicesPaged(ctx context.Context, g *datastore.Group, pageable datastore.Pageable) ([]datastore.Device, datastore.PaginationData, error) {
	devices, paginationData, err := d.deviceRepo.LoadDevicesPaged(ctx, g.UID, pageable)
	if err != nil {
