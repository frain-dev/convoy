	...
	tests := []struct {
	...
	}{
		{
			...
			dbFn: func(es *EventService) {
				...
				ss.EXPECT().FindEndpointByID(gomock.Any(), gomock.Any(), gomock.Any()).
	...
	tests := []struct {
	...
	}{
		{
			...
			dbFn: func(es *EventService) {
				...
				er.EXPECT().FindEndpointByID(gomock.Any(), gomock.Any(), gomock.Any()).
					Times(1).Return(&datastore.Endpoint{Status: datastore.ActiveEndpointStatus}, nil)
		...
		},
		{
			...
			dbFn: func(es *EventService) {
				...
				s.EXPECT().FindEndpointByID(gomock.Any(), gomock.Any(), gomock.Any()).
					Times(1).Return(nil, datastore.ErrEndpointNotFound)
			},
			args: args{
				ctx: ctx,
