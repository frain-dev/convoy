...
func TestSubscription(t *testing.T) {
	t.Run("LoadSubscriptionsPaged", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("CountEndpointSubscriptions", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("FindSubscriptionByID", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("FindSubscriptionsBySourceID", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("FindSubscriptionByEndpointID", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("FindSubscriptionByDeviceID", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
	...
	t.Run("FindCLISubscriptions", func(t *testing.T) {
		db, closeFn := getDB(t)
		defer closeFn()
