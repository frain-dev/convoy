...
func Test_computeJSONHmac(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := ComputeJSONHmac("SHA256", tt.args.data, tt.args.secret, tt.args.order, tt.args.timestamp)
...
func Test_computeJSONHmac_DifferentHashes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := ComputeJSONHmac(tt.args.hash, tt.args.data, tt.args.secret, tt.args.order, tt.args.timestamp)
			if (err != nil) != tt.wantErr {
				t.Errorf("ComputeJSONHmac() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
