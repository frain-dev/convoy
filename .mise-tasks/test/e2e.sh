...
tests=(
  ...
  "TestE2E_GooglePubSub_Single_BasicDelivery"
  "TestE2E_GooglePubSub_Fanout_MultipleEndpoints"
  "TestE2E_GooglePubSub_Broadcast_AllSubscribers"
  "TestE2E_GooglePubSub_Single_EventTypeFilter"
  "TestE2E_GooglePubSub_Single_WildcardEventType"
  "TestE2E_GooglePubSub_Fanout_EventTypeFilter"
  "TestE2E_GooglePubSub_Broadcast_EventTypeFilter"
  "TestE2E_GooglePubSub_Single_BodyFilter_Equal"
  "TestE2E_GooglePubSub_Single_BodyFilter_GreaterThan"
  "TestE2E_GooglePubSub_Single_BodyFilter_In"
  "TestE2E_GooglePubSub_Single_HeaderFilter"
  "TestE2E_GooglePubSub_Single_CombinedFilters"
  "TestE2E_GooglePubSub_Single_SourceBodyTransform"
  "TestE2E_GooglePubSub_Single_SourceHeaderTransform"
  "TestE2E_GooglePubSub_Single_NoMatchingSubscription"
  "TestE2E_GooglePubSub_Single_InvalidEndpoint"
  "TestE2E_GooglePubSub_Single_MissingEventType"
  "TestE2E_GooglePubSub_Single_MalformedPayload"
  "TestE2E_GooglePubSub_Fanout_MissingOwnerID"
  "TestE2E_GooglePubSub_Single_FilterMismatch"
  "TestE2E_GooglePubSub_Single_MultipleWorkers"
)
