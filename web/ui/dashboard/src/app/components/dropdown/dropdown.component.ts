...
export class DropdownComponent implements OnInit {
	...
	get classes(): string {
		return `absolute top-[110%] w-full bg-white-100 border border-grey-10 rounded-12px shadow-default z-10 ${this.sizes[this.size]} ${this.position === 'right' ? 'right-[5%]' : 'left-[5%]'} ${
