...
@NgModule({
	...
	imports: [CommonModule, ReactiveFormsModule, InputComponent, ButtonComponent, RadioComponent, TooltipComponent, InputFieldDirective, InputErrorComponent, InputDirective, LabelComponent],
