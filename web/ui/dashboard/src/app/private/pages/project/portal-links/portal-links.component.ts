...
export class PortalLinksComponent implements OnInit {
	...
	constructor(public privateService: PrivateService, public router: Router, private route: ActivatedRoute, private generalService: GeneralService, public licenseService: LicensesService) {}
