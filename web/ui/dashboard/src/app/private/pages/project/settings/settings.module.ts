...
@NgModule({
	...
	imports: [CommonModule, RouterModule.forChild(routes), CreateProjectComponentModule, LoaderModule, DeleteModalComponent, CardComponent, ButtonComponent, PermissionDirective, DialogDirective]
})
