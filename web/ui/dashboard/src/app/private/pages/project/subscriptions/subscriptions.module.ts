...
@NgModule({
	...
	imports: [CommonModule, RouterModule.forChild(routes), CreateSubscriptionModule, ButtonComponent, ModalComponent, CardComponent, ListItemComponent, TagComponent, EmptyStateComponent, CopyButtonComponent, FormatSecondsPipe, DeleteModalComponent, SourceValueModule]
})
