...
@Component({
	...
	standalone: true,
	imports: [CommonModule, ButtonComponent, ReactiveFormsModule, ModalComponent, InputComponent, LoaderModule, InputFieldDirective, InputErrorComponent, InputDirective, LabelComponent],
