...
@NgModule({
	...
	imports: [CommonModule, RouterModule.forChild(routes), CreateProjectComponentModule, ModalComponent, DialogDirective, ButtonComponent, LoaderModule, ModalHeaderComponent]
})
