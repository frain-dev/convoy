...
export interface ENDPOINT {
	...
	// Circuit breaker state ("open" | "half-open" | "closed"), null when CB is
	// off/unlicensed or has no sample. Reflected on the Status column.
	cb_state: string | null;
	period_failure_rate: number | null;
	success_count?: number | null;
	failure_count?: number | null;
	// Deliveries still retrying after at least one failed attempt; counted into
	// period_failure_rate as failures-so-far.
