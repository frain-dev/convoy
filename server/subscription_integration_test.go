...
func (s *SubscriptionIntegrationTestSuite) Test_CreateSubscription_IncomingProject() {
	...
	endpoint, _ := testdb.SeedEndpoint(s.ConvoyApp.A.Store, project, uuid.NewString(), "", "", false)
...
func (s *SubscriptionIntegrationTestSuite) Test_ToggleSubscriptionStatus_ActiveStatus() {
	...
	endpoint, _ := testdb.SeedEndpoint(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", false)
	source, _ := testdb.SeedSource(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", nil)
	_, _ = testdb.SeedSubscription(s.ConvoyApp.A.Store, s.DefaultProject, subscriptionId, datastore.OutgoingProject, source, endpoint, &datastore.RetryConfiguration{}, &datastore.AlertConfiguration{}, &datastore.FilterConfiguration{}, datastore.ActiveSubscriptionStatus)

	// Arrange Request
	url := fmt.Sprintf("/api/v1/projects/%s/subscriptions/%s/toggle_status", s.DefaultProject.UID, subscriptionId)
...
func (s *SubscriptionIntegrationTestSuite) Test_ToggleSubscriptionStatus_InactiveStatus() {
	...
	endpoint, _ := testdb.SeedEndpoint(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", false)
	source, _ := testdb.SeedSource(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", nil)
	_, _ = testdb.SeedSubscription(s.ConvoyApp.A.Store, s.DefaultProject, subscriptionId, datastore.OutgoingProject, source, endpoint, &datastore.RetryConfiguration{}, &datastore.AlertConfiguration{}, &datastore.FilterConfiguration{}, datastore.InactiveSubscriptionStatus)
...
func (s *SubscriptionIntegrationTestSuite) Test_ToggleSubscriptionStatus_PendingStatus() {
	...
	endpoint, _ := testdb.SeedEndpoint(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", false)
	source, _ := testdb.SeedSource(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", nil)
	_, _ = testdb.SeedSubscription(s.ConvoyApp.A.Store, s.DefaultProject, subscriptionId, datastore.OutgoingProject, source, endpoint, &datastore.RetryConfiguration{}, &datastore.AlertConfiguration{}, &datastore.FilterConfiguration{}, datastore.PendingSubscriptionStatus)
...
func (s *SubscriptionIntegrationTestSuite) Test_ToggleSubscriptionStatus_UnknownStatus() {
	...
	endpoint, _ := testdb.SeedEndpoint(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", false)
	source, _ := testdb.SeedSource(s.ConvoyApp.A.Store, s.DefaultProject, uuid.NewString(), "", "", nil)
	_, _ = testdb.SeedSubscription(s.ConvoyApp.A.Store, s.DefaultProject, subscriptionId, datastore.OutgoingProject, source, endpoint, &datastore.RetryConfiguration{}, &datastore.AlertConfiguration{}, &datastore.FilterConfiguration{}, "random")
