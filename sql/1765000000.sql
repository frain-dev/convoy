...
INSERT INTO convoy.feature_flags (id, feature_key, enabled, allow_override) VALUES
    (gen_random_uuid()::text, 'mtls', false, true),
    (gen_random_uuid()::text, 'oauth-token-exchange', false, true),
    (gen_random_uuid()::text, 'ip-rules', false, true),
    (gen_random_uuid()::text, 'retention-policy', false, true),
    (gen_random_uuid()::text, 'full-text-search', false, true)
