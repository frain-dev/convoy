...
ALTER TABLE convoy.project_configurations
    ...
    ADD COLUMN IF NOT EXISTS circuit_breaker_error_threshold real NOT NULL DEFAULT 20.0;

ALTER TABLE convoy.endpoints
    ADD COLUMN IF NOT EXISTS circuit_breaker_duration int NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS circuit_breaker_error_threshold real NOT NULL DEFAULT 0.0;
