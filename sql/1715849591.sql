...
ALTER TABLE convoy.configurations ADD COLUMN IF NOT EXISTS retention_policy_policy TEXT NOT NULL default '72h';
...
ALTER TABLE convoy.project_configurations ADD COLUMN IF NOT EXISTS retention_policy_policy TEXT NOT NULL default '72h';
