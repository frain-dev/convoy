...
-- +migrate Down
DROP INDEX IF EXISTS convoy.idx_event_deliveries_status;
DROP INDEX IF EXISTS convoy.idx_event_deliveries_project_id_endpoint_id_status;
DROP INDEX IF EXISTS convoy.idx_event_deliveries_project_id_event_id;
DROP INDEX IF EXISTS convoy.idx_event_deliveries_project_id_endpoint_id;
DROP INDEX IF EXISTS convoy.idx_events_source_id;
DROP INDEX IF EXISTS convoy.idx_events_project_id_source_id;
