-- +migrate Up
create type portal_auth_types as enum ('none', 'static_token', 'owner_id', 'refresh_token');
alter table convoy.portal_links add column auth_type portal_auth_types not null default 'refresh_token';
